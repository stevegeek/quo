...
class Quo::MergedQueryTest < ActiveSupport::TestCase
  test "#to_s when 1 source is a query object subclass" do
    ...
    merged = Quo::MergedQuery.new(NewCommentsForAuthorQuery, nested, Quo::EagerQuery.new(nil))
  ...
  test "#to_s when 2 eager sources are provided" do
    merged = Quo::MergedQuery.new(NewCommentsForAuthorQuery, Quo::EagerQuery.new(nil), Quo::EagerQuery.new(nil))
    assert_equal "Quo::MergedQuery[Quo::EagerQuery, Quo::EagerQuery]", merged.to_s
  end

  test "#to_s when 1 source is a merged query" do
    nested = Quo::MergedQuery.new(NewCommentsForAuthorQuery, Quo::EagerQuery.new(nil), Quo::EagerQuery.new(nil))
    merged = Quo::MergedQuery.new(NewCommentsForAuthorQuery, nested, Quo::EagerQuery.new(nil))
